...
export const AllTicketsView: React.FC<AllTicketsViewProps> = ({
  ...
  return (
    <div className="all-tickets-container">
      ...
      {/* SECTION 1 — TICKET SUMMARY (7 Compact KPI Cards) */}
      <div className="all-tickets-kpi-grid">
        <div
          className="all-tickets-kpi-card"
          onClick={() => {
            resetQuickFilters();
          }}
        >
          <span className="all-tickets-kpi-title">Total</span>
          <span className="all-tickets-kpi-val">128</span>
        </div>
        ...
        >
          <span className="all-tickets-kpi-title">Received</span>
          <span className="all-tickets-kpi-val" style={{ color: '#1E40AF' }}>24</span>
        </div>
        ...
        >
          <span className="all-tickets-kpi-title">Unassigned</span>
          <span className="all-tickets-kpi-val" style={{ color: '#D97706' }}>6</span>
        </div>
        ...
        >
          <span className="all-tickets-kpi-title">Being Worked On</span>
          <span className="all-tickets-kpi-val" style={{ color: '#92400E' }}>18</span>
        </div>
        ...
        <div
          ...
          onClick={() => {
            resetQuickFilters();
            setSlaFilter('at-risk');
          }}
        >
          <span className="all-tickets-kpi-title">SLA At Risk</span>
          <span className="all-tickets-kpi-val" style={{ color: '#B45309' }}>3</span>
        </div>
        ...
        >
          <span className="all-tickets-kpi-title">SLA Breached</span>
          <span className="all-tickets-kpi-val" style={{ color: '#DC2626' }}>1</span>
        </div>
        ...
        >
          <span className="all-tickets-kpi-title">Resolved Today</span>
          <span className="all-tickets-kpi-val" style={{ color: '#065F46' }}>14</span>
        </div>
      </div>
